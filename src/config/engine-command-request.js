const TEST_HUMAN = "force-crash-65kph-post-fix";
const VEHICLE = "br-jeep-1";
const TEST_NOW = 1788175200000;

export const ENGINE_COMMAND_REQUEST = Object.freeze({
  id: 242,
  mode: "battle-royale",
  room: "force-crash-65kph-post-fix-242",
      ...
      { command: "service.call", args: { service: "battle-royale", method: "arm", arguments: [TEST_NOW] } },
      {
        ...
        args: {
          ...
          arguments: [{
            ...
            name: "Post Fix Crash Driver 65 kmh",
            bot: false,
            alive: true,
            health: 100,
  ...
  requestedAt: "2026-08-31T14:15:00+03:00"
});
