const TEST_HUMAN = "force-crash-open-road-control";
const VEHICLE = "br-jeep-1";
const TEST_NOW = 1788175500000;

export const ENGINE_COMMAND_REQUEST = Object.freeze({
  id: 243,
  mode: "battle-royale",
  room: "force-crash-open-road-control-243",
  ...
  args: {
    commands: [
      ...
      { command: "service.call", args: { service: "physics", method: "setDynamicBodyTranslation", arguments: [VEHICLE, { x: 500, y: 1.25, z: 500 }, true] } },
  ...
  requestedAt: "2026-08-31T14:20:00+03:00"
});
