export const ENGINE_COMMAND_REQUEST = Object.freeze({
  id: 11,
  mode: "battle-royale",
  room: "engine-lab-warehouse-search-11",
  command: "engine.batch",
  args: {
    commands: [
      { command: "service.call", args: { service: "match-api", method: "connectHuman", arguments: ["engine-search-trace-source"] } },
      { command: "service.call", args: { service: "movement", method: "teleport", arguments: ["br-bot-2", { x: 80, y: 0, z: 0, angle: -1.5707963267948966 }] } },
      { command: "service.call", args: { service: "movement", method: "teleport", arguments: ["engine-search-trace-source", { x: 54, y: 3.2, z: 5, angle: 1.5707963267948966 }] } },
      ...
      { command: "event.emit", args: { event: "sound:spatial", payload: { entityId: "engine-search-trace-source", key: "weapon.pistol.fire", radius: 110, x: 54, y: 3.2, z: 5 } } },
      { command: "service.call", args: { service: "movement", method: "teleport", arguments: ["engine-search-trace-source", { x: -300, y: 0, z: -300, angle: 0 }] } },
  ...
  requestedAt: "2026-08-26T08:39:00Z"
});