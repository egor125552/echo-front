export const ENGINE_COMMAND_REQUEST = Object.freeze({
  id: 34,
  mode: "battle-royale",
  room: "engine-lab-warehouse-search-34",
  command: "engine.batch",
  repeat: 1,
  frameEvery: 1,
  args: {
    commands: [
      { command: "service.call", args: { service: "match-api", method: "connectHuman", arguments: ["engine-provoker-34"] } },
      { command: "game.step", args: { dt: 0.05, steps: 140 } },
      { command: "service.call", args: { service: "physics", method: "teleport", arguments: ["engine-provoker-34", { x: 60, y: 0, z: 0 }] } },
      { command: "component.patch", args: { entityId: "engine-provoker-34", component: "Transform", patch: { x: 60, y: 0, z: 0, angle: 1.5707963267948966 } } },
      ...
      { command: "event.emit", args: { event: "sound:spatial", payload: { entityId: "engine-provoker-34", key: "weapon.pistol", x: 60, y: 0, z: 0, radius: 110 } } },
  ...
  requestedAt: "2026-08-26T13:40:00Z"
});