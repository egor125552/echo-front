const TEST_HUMAN = "force-crash-calibrated-driver";
const VEHICLE = "br-jeep-1";
const TEST_NOW = 1788172500000;

export const ENGINE_COMMAND_REQUEST = Object.freeze({
  id: 233,
  mode: "battle-royale",
  room: "force-crash-calibrated-e2e-233",
      ...
      { command: "service.call", args: { service: "battle-royale", method: "arm", arguments: [TEST_NOW] } },
      {
        ...
        args: {
          ...
          arguments: [{
            ...
            name: "Calibrated Force Crash Driver",
            bot: false,
            alive: true,
            health: 100,
  ...
  requestedAt: "2026-08-31T13:30:00+03:00"
});
