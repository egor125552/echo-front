...
const TRUCK_ENGINE_URL = "/assets/audio/vehicles/ts3/ts3_truck_engine.mp3";
const SPORT_ENGINE_URL = "/assets/audio/vehicles/ts3/engine.mp3";
const BRAKE_URL = "/assets/audio/vehicles/ts3/brake_builtin6.mp3";
