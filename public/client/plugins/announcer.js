...
export async function setup(ctx) {
  ...
  ctx.events.on("network:welcome", ({ team: joinedTeam }) => {
    ...
    announce(
      ...
      "Стрелки вверх и вниз — движение вперёд и назад. Стрелки влево и вправо поворачивают вас и служат для прицеливания: доведите звук противника примерно в центр и стреляйте X. " +
      "Q и E — короткие боковые шаги влево и вправо. После первого раунда откроется автомат. У прицела есть небольшой допуск. Shift — бег. Удерживайте Z и нажимайте стрелки влево или вправо, чтобы сменить открытое оружие.",
      { interrupt: true },
    );
  });
