...
export async function setup(ctx) {
  ...
  ctx.events.on("network:welcome", ({ team: joinedTeam }) => {
    ...
    announce(
      ...
      "После первого раунда откроется автомат. У прицела есть небольшой допуск, поэтому достаточно навести противника примерно по центру звука. " +
      "Стрелки вверх и вниз — вперёд и назад, влево и вправо — короткие боковые шаги. Q и E — поворот. " +
