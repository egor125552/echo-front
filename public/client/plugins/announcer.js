...
export async function setup(ctx) {
  ...
  ctx.events.on("network:welcome", ({ team: joinedTeam }) => {
    ...
    announce(
      ...
      "Q и E — короткие боковые шаги. В пистолете пятьдесят патронов, ещё триста пятьдесят в запасе. После первого раунда откроется автомат и сложность станет обычной. Shift — бег. Удерживайте Z и нажимайте стрелки влево или вправо, чтобы сменить открытое оружие.",
      { interrupt: true },
    );
  });
