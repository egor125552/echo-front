...
const TEAM_MESSAGES = {
  ...
  reload: "Противник уничтожен. Теперь перезаряди оружие. На клавиатуре нажми R. На сенсорном экране нажми Перезарядка.",
...
const BATTLE_ROYALE_MESSAGES = {
  ...
  "apply-armor": "Броня разрушена. Чтобы восстановить её, поставь бронепластину. На клавиатуре нажми B. Во время установки не двигайся и не стреляй.",
