...
export async function setup(ctx) {
  ...
  ctx.events.on("network:welcome", ({ team: joinedTeam }) => {
    ...
    announce(
      ...
      "Стрелки вверх и вниз — движение вперёд и назад. Стрелки влево и вправо поворачивают вас и служат для прицеливания: доведите звук противника ближе к центру и стреляйте X. " +
